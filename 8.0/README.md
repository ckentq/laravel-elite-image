...
```bash
wget https://github.com/ckentq/laravel-elite-image/raw/{version}/8.0/setup/Dockerfile
wget https://github.com/ckentq/laravel-elite-image/raw/{version}/8.0/setup/Envoy.blade.php
wget https://github.com/ckentq/laravel-elite-image/raw/{version}/8.0/setup/docker-compose.yml.example
...
1. 下載Nginx設定檔 `wget https://github.com/ckentq/laravel-elite-image/raw/{version}/8.0/config/nginx.conf`
...
1. 下載PHP設定檔 `wget https://github.com/ckentq/laravel-elite-image/raw/{version}/8.0/config/php.ini`

2. 下載PHP-FPM設定檔 `wget https://github.com/ckentq/laravel-elite-image/raw/{version}/8.0/config/www.ini`
